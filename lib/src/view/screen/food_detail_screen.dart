...
class FoodDetailScreen extends StatelessWidget {
  ...
  PreferredSizeWidget _appBar(BuildContext context) {
    return AppBar(
      title: Text(
        ...
        style: TextStyle(
          color: homeController.isLightTheme ? Colors.black : Colors.white,
        ),
      ),
      leading: IconButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: GetBuilder(builder: (HomeController controller) {
        return fab(() => controller.isFavoriteFood(food));
      }),
